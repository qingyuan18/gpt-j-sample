...
if __name__ == "__main__":
    ...
    os.system("chmod +x ./configz_and_code/scripts/torch_launch.sh")
    os.system("chmod +x ./configz_and_code/scripts/s5cmd")
    os.system("/bin/bash -c ./configz_and_code/scripts/torch_launch.sh")